...
export class RoleManagementComponent implements OnInit {
  ...
  loadRoles(): void {
    this.loading = true;
    this.http.get<CustomRole[]>(`${this.apiUrl}/club/${this.newRole.clubId}`).subscribe({
      next: (data) => {
        this.roles = data;
        this.loading = false;
      },
  ...
  createRole(): void {
    ...
    this.http.post<CustomRole>(this.apiUrl, this.newRole).subscribe({
      next: () => {
  ...
  updateRole(): void {
    ...
    this.http.put<CustomRole>(`${this.apiUrl}/${this.editingRoleId}`, this.newRole).subscribe({
      next: () => {
