    ...
    <div class="p-6 space-y-6">
      <div class="flex items-center justify-between">
        <div>
          ...
          <p class="text-sm text-gray-500 mt-1">Previsions sur 3 mois par regression lineaire + Gemini AI (BF10)</p>
        </div>
      ...
      <div *ngIf="!loading" class="bg-gray-50 dark:bg-gray-800 rounded-xl border p-4">
        ...
        <p class="text-sm text-gray-500">
          ...
          enrichies par l'<strong>API Gemini</strong> pour l'analyse contextuelle des tendances.
  ...
  ngOnInit() {
    this.api.getPredictions(this.clubId, 3).subscribe({
      next: (data: any[]) => {
        ...
        this.aiSource = src === 'GEMINI_AI' ? 'Gemini AI' : 'Regression lineaire';
        this.aiStatusClass = src === 'GEMINI_AI' ? 'bg-purple-100 text-purple-700' : 'bg-blue-100 text-blue-700';
        this.loading = false;
      },
