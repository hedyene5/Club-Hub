...
import { DashboardComponent } from "./ameni-ve/dashboard/dashboard.component";
...
// Treasury routes (with their own role-based guards)
import { TREASURY_ROUTES } from './treasury/treasury.routes';                // <-- adjust path
...
export const routes: Routes = [
  ...
  // ========== FRONTOFFICE pages (HEADER shown) ==========
  {
    path: 'messaging',
  ...
  // ── Virtual Events (Ameni) – protected, header will be shown ──
  {
    path: 'ameni',
  ...
  // ========== BACKOFFICE (under /app, with sidebar + header) ==========
  {
    path: 'app',
    ...
    children: [
      ...
      { path: 'dashboard', component: DashboardComponent, title: 'Dashboard | ClubHub' },
      ...
      { path: 'setup-club', component: SetupClubComponent, title: 'Créer votre club | ClubHub' },
      ...
      // Voice2
      {
        ...
        children: [
          {
            path: 'analytics',
            loadComponent: () => import('./voice2/pages/analytics/analytics.component').then(m => m.Voice2AnalyticsComponent),
            title: 'Voice2 Analytics | ClubHub',
          },
          {
            path: 'management',
            loadComponent: () => import('./voice2/pages/management/management.component').then(m => m.Voice2ManagementComponent),
            title: 'Voice2 Management | ClubHub',
          },
          {
            path: 'instant-voice',
            loadComponent: () => import('./voice2/pages/instant-voice/instant-voice.component').then(m => m.Voice2InstantVoiceComponent),
            title: 'Voice2 Instant Voice | ClubHub',
          },
          {
            path: 'audio-reports',
            canActivate: [voice2BureauGuard],
            loadComponent: () => import('./voice2/pages/audio-reports/audio-reports.component').then(m => m.Voice2AudioReportsComponent),
            title: 'Voice2 Audio Reports | ClubHub',
          },
          {
            path: 'my-reports',
            canActivate: [voice2MyReportsGuard],
            loadComponent: () => import('./voice2/pages/my-reports/my-reports.component').then(m => m.Voice2MyReportsComponent),
      ...
      {
        path: 'treasury',
        children: TREASURY_ROUTES     // <-- all treasury routes, with their own role guards
      },
    ],
  },
