...
/**
 * Enregistrement de présence pour les élections présentielles
 * Créé lorsqu'un QR code est scanné par un responsable event
 */
...
public class ElectionAttendance {
    ...
    private String scannedBy;      // userId du responsable qui a scanné
    private String votingToken;    // Token unique pour voter
