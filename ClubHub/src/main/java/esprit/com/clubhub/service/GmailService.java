...
public class GmailService {
    ...
    @PostConstruct
    public void init() {
        // Initialisation asynchrone pour ne pas bloquer le démarrage de l'application
        new Thread(() -> {
            try {
    ...
    /**
     * Cherche le fichier credentials.json dans plusieurs emplacements
     */
    private InputStream findCredentialsFile() {
        System.out.println("🔍 Recherche du fichier credentials.json...");
        
        // Méthode 1: Depuis le classpath (resources)
        ...
        // Méthode 2: Depuis src/main/resources
