...
public class PredictionService {
    ...
    private List<PredictionResponse> predictLinear(Map<String, BigDecimal> revenue,
        ...
        double revLast = revValues.isEmpty() ? 0 : revValues.get(revValues.size() - 1).doubleValue();
        double expLast = expValues.isEmpty() ? 0 : expValues.get(expValues.size() - 1).doubleValue();
