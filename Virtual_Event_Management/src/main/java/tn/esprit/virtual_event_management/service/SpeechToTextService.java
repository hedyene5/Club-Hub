...
public class SpeechToTextService {
    ...
    public Transcription transcribe(MultipartFile audioFile,
        ...
        try {
            ...
            transcribedText = callHuggingFace(audioFile.getBytes(), audioFile.getContentType());
        }
    ...
    // ================= HUGGINGFACE =================
    private String callHuggingFace(byte[] audioBytes, String contentType) {

        HttpHeaders headers = new HttpHeaders();
        headers.set("Authorization", "Bearer " + hfToken);
        // Use the original file's content type (e.g. audio/webm) instead of octet-stream
        headers.setContentType(MediaType.parseMediaType(
                contentType != null ? contentType : "audio/webm"));
        // HuggingFace rejects Spring's default "application/*+json" — force plain JSON
