...
export class TreasuryApiService {
  ...
  // Utilise l'endpoint public /demo/late-payment/predictions pour eviter l'auth en demo
  getLatePaymentPredictions(): Observable<LatePaymentPrediction[]> {
    return this.http.get<LatePaymentPrediction[]>('http://localhost:8085/api/v1/demo/late-payment/predictions');
  }
